...
function login($data) {
  if ($data['password_hash'] == $data['password']) {
    ...
    $_SESSION['gelar_s1'] = $data['gelar_s1'];
    $_SESSION['gelar_s2'] = $data['gelar_s2'];
    $_SESSION['gelar_s3'] = $data['gelar_s3'];
...
$gelar_s1 = $result['gelar_s1'];
$gelar_s2 = $result['gelar_s2'];
$gelar_s3 = $result['gelar_s3'];
$email = $result['email'];
