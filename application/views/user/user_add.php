                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/user/user_proses.php?aksi=insert" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="gelar_s1" placeholder="Gelar S1..." required/>
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="gelar_s2" placeholder="Gelar S2..." required/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-graduation-cap"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="gelar_s3" placeholder="Gelar S3..." required/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-graduation-cap"></i>
                                    </div>
                                </div>
