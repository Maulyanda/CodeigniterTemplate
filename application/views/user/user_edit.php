        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/user/user_proses.php?aksi=update&id=<?= $_GET['id'] ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="unit" value="<?= $row['unit'] ?>"/>
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="golongan" value="<?= $row['golongan'] ?>"/>
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="pangkat" value="<?= $row['pangkat'] ?>"/>
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="gelar_s1" value="<?= $row['gelar_s1'] ?>"/>
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="gelar_s2" value="<?= $row['gelar_s2'] ?>"/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-graduation-cap"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="gelar_s3" value="<?= $row['gelar_s3'] ?>"/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-graduation-cap"></i>
                                    </div>
                                </div>
